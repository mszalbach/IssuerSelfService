...
describe('<SecurityTable/>', () => {
    it('should exists', () => {
        let wrapper = shallow(<SecurityTable securities={securities}/>);
        expect(wrapper).not.toBe(null);
    });

    it('should have correct properties', () => {
        let wrapper = mount(<SecurityTable securities={securities}/>);
    ...
    it('should call delete function', () => {
        ...
        let wrapper = mount(<SecurityTable securities={securities} onDelete={onDeleteSpy}/>);
